within ApocalypseDynamics.WorldDynamics.World3;

model Scenario_12 "Influencing the future 20 years later"
  ...
  parameter Real t_fcaor_time(unit = "yr") = 2020 "Year of capital allocation to resource use efficiency";
  parameter Real t_fert_cont_eff_time(unit = "yr") = 2020 "Year of continued fertility change";
  parameter Real t_ind_equil_time(unit = "yr") = 2020 "Year of industrial equilibrium";
  parameter Real t_land_life_time(unit = "yr") = 2020 "Land life time";
  parameter Real t_policy_year(unit = "yr") = 2020 "Year of policy change";
  parameter Real t_pop_equil_time(unit = "yr") = 4000 "Population equilibrium time";
  parameter Real t_zero_pop_grow_time(unit = "yr") = 2020 "Time to zero population growth";
...
This is <font color=red><b>Scenario #12</b></font> of the <font color=red><b>WORLD3</b></font> model. This new scenario made by Arnaud Dorthe starts out with the same assumptions as <font color=red><b>Scenario #10</b></font>. <p>
 
We now want to check what would have happened, had we started controlling our resources from 2020. <p>
...
<font color=red>parameter Real t_fcaor_time(unit=\"yr\") = <b>2020</b> \"Year of capital allocation to resource use efficiency\";</font>. <p>
<font color=red>parameter Real t_fert_cont_eff_time(unit=\"yr\") = <b>2020</b> \"Year of continued fertility change\";</font>. <p>
<font color=red>parameter Real t_ind_equil_time(unit=\"yr\") = <b>2020</b> \"Year of industrial equilibrium\";</font>. <p>
<font color=red>parameter Real t_land_life_time(unit=\"yr\") = <b>2020</b> \"Land life time\";</font>. <p>
<font color=red>parameter Real t_policy_year(unit=\"yr\") = <b>2020</b> \"Year of policy change\";</font>. <p>
<font color=red>parameter Real t_zero_pop_grow_time(unit=\"yr\") = <b>2020</b> \"Time to zero population growth\";</font>. <p>
